...
> **Espelho do arquivo de raiz:** [tarefas a fazer.md](../tarefas%20a%20fazer.md)
...
* **Critérios de Aceite:**
  ...
  * [ ] Atualizar status de `ERR-059` e `ERR-060` no [docs/ERROR_LOG.md](ERROR_LOG.md) para `RESOLVIDO`.
